...
// RefreshButton Component - EXACT copy from crm_demo
...
// UserMenu Component - EXACT copy from crm_demo
    ...
    <header className="bg-secondary border-b border-border">
      <div className="px-4">
        <div className="flex justify-between items-center flex-1 h-12">
          ...
          {/* Right Section: ThemeSwitch + RefreshButton + UserMenu - EXACT copy from crm_demo */}
